...
#ifdef CONFIG_SEC_INCELL
static void synaptics_rmi4_tsp_disable(struct incell_driver_data *param);
static void synaptics_rmi4_tsp_enable(struct incell_driver_data *param);
static void synaptics_rmi4_tsp_esd(struct incell_driver_data *param);
#endif
...
#ifdef CONFIG_SEC_INCELL
	incell_data.tsp_data = rmi4_data;
	incell_data.tsp_disable = synaptics_rmi4_tsp_disable;
	incell_data.tsp_enable = synaptics_rmi4_tsp_enable;
	incell_data.tsp_esd = synaptics_rmi4_tsp_esd;
#endif
...
static void synaptics_rmi4_tsp_disable(struct incell_driver_data *param)
{
	...
	rmi4_data = incell_data.tsp_data;
	dev = rmi4_data->input_dev;
